...
import { Eye, Heart, MessageSquare, Edit, Trash2, Plus } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Kelola semua proyek yang telah Anda buat
          </p>
        </div>
        <Button asChild>
          <Link href="/dashboard/proyek-saya/buat">
            ...
            <Card key={project.id} className="overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <CardFooter className="flex gap-2">
                <Button
                  ...
                  asChild
                >
                  <Link href={`/dashboard/proyek-saya/edit/${project.slug}`}>
